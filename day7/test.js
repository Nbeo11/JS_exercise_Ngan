...
class FormHandler {
    ...
    handleFormSubmit(event) {
        ...
        musicPlayer.musicList.push(newSong); // Assuming musicPlayer is the instance of MusicPlayer
        ...
        musicPlayer.songListContainer.appendChild(songItem); // Thêm bài hát vào danh sách
